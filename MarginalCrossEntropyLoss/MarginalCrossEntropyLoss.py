...
class MarginalCrossEntropyLoss(_Loss):
    ...
    """
    def __init__(self, marginal_indexes, numclass, size_average=True, reduce=True):
        ...
        Input:
            ...
            """
        super(MarginalCrossEntropyLoss, self).__init__(size_average=size_average)
        self.reduce=reduce
        marginal_masks = []
    ...
    def forward(self, input, marginal_targets):
        ...
        loss+=F.cross_entropy(input,marginal_targets[:,-1], size_average=False, reduce=False)
